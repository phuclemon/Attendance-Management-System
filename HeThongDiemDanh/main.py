...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        self.root.title("THPT Chuyên Lê Quý Đôn Bình Định")
        ...
        time_img = Label(self.root, image=self.photoimgtime,bg="#ededed")
        time_img.place(x=43, y=40, width=27, height=27)
        def time():
            string=strftime('%H:%M:%S %p')
            lbl.config(text=string)
            lbl.after(1000,time)
        lbl=Label(self.root,font=("yu gothic ui", 13, "bold"),bg="#ededed", fg="black")
        lbl.place(x=80,y=35,width=100,height=20)
        time()
        lbl1 = Label(self.root,text=today, font=("yu gothic ui", 13, "bold"), bg="#ededed", fg="black")
        lbl1.place(x=80, y=60, width=100, height=20)

        #====title=========
        self.txt = "Võ Minh Phúc 12Tin"
        self.count = 0
        self.text = ''
        self.color = ["#4f4e4d", "#f29844", "red2"]
        self.heading = Label(self.root, text=self.txt, font=("yu gothic ui", 26, "bold"), bg="#ededed", fg="white",
                             bd=5, relief=FLAT)
        ...
        time_img = Label(self.root, image=self.photoimgpeop, bg="#ededed")
        time_img.place(x=970, y=48, width=30, height=30)
        self.lblemail = Label(self.root,text=self.account, font=("yu gothic ui", 20, "bold"), bg="#ededed", fg="green")
        self.lblemail.place(x=1000, y=48, width=170, height=28)
        ...
        b1 = Button(self.root, image=self.photoimglogout, cursor="hand2", command=self.exit,borderwidth=0,bg="#ededed")
        b1.place(x=1350, y=45, width=27, height=27)

        b1_1 = Button(self.root, text="Đăng xuất", cursor="hand2", command=self.exit,
                      font=("times new roman", 13, "bold"),
                      bg="#ededed", fg="black",borderwidth=0)
        ...
        b2.place(x=155, y=490, width=170, height=170)
        ...
        btn2 = Button(self.root, text="Học sinh", font=("yu gothic ui", 16, "bold"),command=self.student_details, image=self.photobtn2,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        btn2.place(x=155, y=200, width=170, height=170)
        ...
        b3 = Button(self.root, text="Nhận diện", font=("yu gothic ui", 16, "bold"),command=self.face_recognition ,image=self.photobtn3,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b3.place(x=425, y=200, width=170, height=170)
        ...
        b4 = Button(self.root, text="Điểm danh", font=("yu gothic ui", 16, "bold"),command=self.attendance_data ,image=self.photobtn4,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b4.place(x=675, y=200, width=170, height=170)
        ...
        b5 = Button(self.root, text="Môn học", font=("yu gothic ui", 16, "bold"),command=self.subject_data, image=self.photobtn5,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b5.place(x=925, y=200, width=170, height=170)
        ...
        b6 = Button(self.root, text="Giáo viên", font=("yu gothic ui", 16, "bold"),command=self.teacher_data, image=self.photobtn6,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b6.place(x=425, y=490, width=170, height=170)
        ...
        b7 = Button(self.root, text="Buổi học", font=("yu gothic ui", 16, "bold"),command=self.lesson_data, image=self.photobtn7,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b7.place(x=675, y=490, width=170, height=170)
        ...
        b8 = Button(self.root, text="Xem ảnh", font=("yu gothic ui", 16, "bold"),command=self.open_img, image=self.photobtn8,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b8.place(x=925, y=490, width=170, height=170)
        # ===========MASK1===============
        img_btn9 = PIL.Image.open(r"ImageFaceDetect\mask1.png")
        img_btn9 = img_btn9.resize((80, 113), PIL.Image.ANTIALIAS)
        self.photobtn9 = ImageTk.PhotoImage(img_btn9)

        b9 = Button(self.root, text="MASK", font=("yu gothic ui", 16, "bold"), #command=self.attendance_data,
                    image=self.photobtn9,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b9.place(x=1190, y=200, width=170, height=170)
        # ===========MASK2===============
        img_btn10 = PIL.Image.open(r"ImageFaceDetect\mask2.png")
        img_btn10 = img_btn10.resize((80, 113), PIL.Image.ANTIALIAS)
        self.photobtn10 = ImageTk.PhotoImage(img_btn10)

        b10 = Button(self.root, text="MASK", font=("yu gothic ui", 16, "bold"), #command=self.open_img,
                    image=self.photobtn10,
                    cursor="hand2",
                    activebackground="white", bg="white", borderwidth=0, compound="top")
        b10.place(x=1190, y=490, width=170, height=170)
        #off
