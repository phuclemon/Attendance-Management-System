...
class Login_Window:
    def __init__(self,root):
        ...
        left_lbl=Label(self.root,bg="#66A5AD",bd=0)
        left_lbl.place(x=0,y=0,relheight=1,width=250)

        right_lbl = Label(self.root, bg="#66A5AD", bd=0)
        right_lbl.place(x=600, y=0, relheight=1, relwidth=1)

        #===========Frame============
        login_frame=Frame(self.root,bg="white")
        login_frame.place(x=250,y=100,width=1250,height=500)
        #===========style_ttk.tentry===========
        self.estyle = ttk.Style()
        self.estyle.configure("EntryStyle.TEntry", background='black')

        title=Label(login_frame,text="Đăng nhập ",font=("times new roman",30,"bold"),bg="white",fg="#003B48").place(x=250,y=40)

        email = Label(login_frame, text="Tài Khoản", font=("times new roman", 18, "bold"), bg="white",
                      fg="#003B48").place(x=250, y=130)
        ...
        btn_login = Button(login_frame, text="Đăng nhập", command=self.login,font=("times new roman", 17,"bold"), fg="white", bd=0,
                            bg="#07565B",cursor="hand2").place(x=250, y=400,width=220,height=40)


        #=============clock============
        self.lbl = Label(self.root, bg="#003B48",text=today,font=("Book Antiqua",20,"bold"),compound=BOTTOM,fg="white", bd=0)
